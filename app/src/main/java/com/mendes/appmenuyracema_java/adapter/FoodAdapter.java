package com.mendes.appmenuyracema_java.adapter;
...
import com.mendes.appmenuyracema_java.databinding.FoodItemBinding;
...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.FoodViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FoodViewHolder holder, int position) {
        ...
        holder.binding.txtFoodDescription.setText(foodList.get(position).getFoodDescrition());
